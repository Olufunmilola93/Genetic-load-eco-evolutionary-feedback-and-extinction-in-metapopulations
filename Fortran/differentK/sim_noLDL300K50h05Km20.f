...
!         new allele frequency
 ...
 19   open(41,file='L300_K50_dom0.5_Km20_Ks10_statsB.txt')
      do i=1,tsteps/20
 ...
 9    Format(I8,1X,F15.9,1X,F15.9,1X,F15.9)
      ...
      open(41,file='L300_K50_dom0.5_Km20_Ks10_tseriesB.txt')
      do i=1,tsteps   ! pop size in deme 10,20,30,..100  vs. generation.
      write(41,8) i,(tseriesN(k,i),k=1,10)
